    ...
    return (
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                        ...
                                        <h3 className="mt-2">DR. ATM REZAUL KARIM</h3>
        ...
        <div className="container px-4">
            <div className="row gx-0">
                <div className="col">
                <div className="p-3 border bg-secondary fw-bold"><i className="fas fa-ambulance"></i> 24 Hours Ambulance Service</div>
                </div>
                <div className="col">
                <div className="p-3 border bg-info fw-bold"><i className="fas fa-user-md"></i> Best doctor is in here for you</div>
                </div>
                <div className="col">
                <div className="p-3 border bg-secondary fw-bold"><i className="fas fa-syringe"></i> You will get best and safe surgery </div>
                </div>
            </div>
            </div>
